...
export default function SingleTheme(props: SingleThemeProp) {
    ...
    return (
        <tr>
            ...
            <EditAndDelete route={`/edit-theme/${props.value._id}`} deleteFunc={() => props.deleteFunc(props.value._id)} />
        </tr>
